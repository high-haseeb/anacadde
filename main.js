...
setFlashingLabel(label) {
    ...
    let tempDelta = this.labelCameraTargets.filter(target => target.label === this.flashingLabel)[0].deltaTarget;
    ...
    if (this.mobileCheck()) {
        ...
        if (label == "İletişim") {
            ...
            this.targetPosition.copy(new THREE.Vector3(temp.x, 1, temp.z).sub({ x: 8.0, y: 0, z: 7.0 }));
        } else {
